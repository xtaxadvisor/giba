...
export async function checkSupabaseConnection() {
    try {
        ...
        if (!rpcError && rpcData?.success) {
            useNotificationStore.getState().addNotification('Successfully connected to database', 'success');
            return true;
        }
...
export function validateSupabaseConfig() {
    ...
    if (!url || !key) {
        ...
        useNotificationStore.getState().addNotification('Supabase configuration is incomplete', 'error');
        return false;
    }
    try {
        // Validate URL format
        ...
        useNotificationStore.getState().addNotification('Invalid Supabase configuration', 'error');
        return false;
    }
}
