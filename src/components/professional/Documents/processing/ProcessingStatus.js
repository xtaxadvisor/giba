...
export function ProcessingStatus({ steps, startTime }) {
    const processingTime = calculateProcessingTime(startTime);
    return (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("span", { className: "text-sm font-medium text-gray-500", children: "Processing Time" }), _jsx("span", { className: "text-sm text-gray-900", children: processingTime })] }), _jsx("div", { className: "relative", children: steps.map((step) => (_jsxs("div", { className: "flex items-center mb-4", children: [_jsx("div", { className: `p-2 rounded-full ${step.status === 'completed' ? 'bg-green-100' :
