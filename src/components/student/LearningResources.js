...
export function LearningResources() {
    ...
    if (selectedResource) {
        ...
        if (resource) {
            ...
            return (_jsxs("div", { children: [_jsx(Button, { variant: "ghost", className: "mb-6", onClick: () => setSelectedResource(null), children: "\u2190 Back to Resources" }), _jsx(ResourceComponent, {})] }));
        }
    }
