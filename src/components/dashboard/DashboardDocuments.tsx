...
const DashboardDocuments: React.FC = () => {
  ...
  const documents: Document[] = [
    { id: "1", name: "Tax_Return_2023.pdf", type: "PDF", size: "2.4 MB", uploadedAt: "2024-03-15", status: "approved" },
    { id: "2", name: "Business_Expenses_Q1.xlsx", type: "Excel", size: "1.8 MB", uploadedAt: "2024-03-14", status: "pending" },
    { id: "3", name: "Investment_Portfolio.pdf", type: "PDF", size: "3.2 MB", uploadedAt: "2024-03-13", status: "rejected" }
  ];
