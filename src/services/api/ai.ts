...
export const aiService = {
  async getResponse(message: string, context: string = 'general') {
    try {
      const systemPrompt = CONTEXT_PROMPTS[context as keyof typeof CONTEXT_PROMPTS] || CONTEXT_PROMPTS.general;
