...
class EmailService {
    ...
    async sendEmail(to, subject, body, options = {}) {
        try {
            ...
            useNotificationStore.getState().addNotification('Failed to send email. Please try again later.', 'error');
            throw error;
        }
    }
    async sendTestEmail() {
        return this.sendEmail('test@example.com', 'SMTP Test', 'If you received this email, SMTP is working!', {
